...
class IIssue(model.Schema):
    ...
    release = schema.TextLine(title=_(u'Release'),
    ...
    steps = RichText(title=_(u'Steps To Reproduce'),
    ...
    watchers = schema.List(title=_(u'Watchers'),
    ...
    subject = schema.List(title=_(u'Subject'),
